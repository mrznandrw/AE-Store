...
import { fetchBrands, deleteBrand } from '../http/productAPI.js'
import { Button, Container, Spinner, Table } from 'react-bootstrap'
import EditBrand from '../components/modals/EditBrand.js'
...
const AdminBrands = () => {
    ...
    return (
        <Container>
            <h1>Бренды</h1>
            <Button onClick={() => handleCreateClick()}>Добавить бренд</Button>
